...
# ==================================================
# Regex to extract scalar parameters (with default)
# Supports:
# param X default 10;
# param X default 10 := 10;
# ==================================================
param_pattern = re.compile(
    r"^\s*param\s+(\w+)\s+(?:default\s+([0-9.eE+-]+))?",
    re.IGNORECASE
)

def load_parameters():
    """Load scalar parameters with default values from parameters.mod"""
    params = {}
...
# ==================================================
# Write user parameter file (let commands)
# ==================================================
def write_user_parameters(params_dict):
    """Write overrides to user_parameters.mod"""
